// @massing/ifc — the IFC file, as a thing you can edit without breaking.
//
...
//
// No dependencies beyond @massing/core, no DOM, no WASM. Tessellation and booleans live elsewhere; this
